...
Config = {
	...
	maxRaycastDistance = 120,		-- meters bots start shooting at player
	...
	shootBackIfHit = fals,			-- bot shoots back, if hit
	...
	maxBotAttackBotDistance = 100,	-- meters a bot attacks an other bot
	...
	settingsPassword = "botpass",		-- if nil, disable it. Otherwise use a String with your password
