...
-- To Change Preset on a Map do "Mapname.PresetName" (Preset Names: Night, Bright_Night, Morning, Evening)
   ...
   -- e.g Bazaar.Evening
        ...
        --DLC Close Quarters
        ['Donya.Morning']                         = true,             --XP2_Palace  | Donya Fortress
        ['Operation925.Morning']                  = true,             --XP2_Office  | Operation 925
        ['Scrapmetal.Morning']                    = true,             --XP2_Factory | Scrapmetal
        ['Ziba.Morning']                          = true,             --XP2_Skybar  | Ziba Tower
